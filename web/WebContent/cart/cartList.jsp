 ...
 /*   $(function(){
	   var price=0;
		 ...
		 $("input#sale").click(function(){
			 $("input#total").val(eval($("input#total").val())-1000);
			 $(this).hide(1000);
		 });
  */
			...
			<div id="contentsWrap" class="sub_con5">
				<div class="board_form">   
					...
					<div class="btnSet clfix mgb15">
						<span class="fr"> <span class="button"><a href="/web/shoppingList.do?cmd=shoppingList">목록</a></span>
						</span>
					</div>
					...
					<table class="bbsWrite mgb35">
						...
						<tbody>
							...
							<table class="bbsList">
					         ...
					         <c:forEach var="i" items="${basket}" varStatus="cnt">			
									<tr>
										...
										<td>${i.productPrice}
										  <input type="text" name="price" value="${i.productPrice}"  />
										</td>
							...
							<tr align="right">
								...
								<th align="right">총합계 &nbsp; <input type="text" name="total" id="total" class="inputText" readonly="readonly"  size="30"  align="right" value=""/>
								
								<input type="button" value="1000원 할인" id="sale"/>
								</th>
								</tr>	
							</table>	
						</div>
